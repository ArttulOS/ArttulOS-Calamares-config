...
Page {
    ...
    header: Kirigami.Heading {
        ...
        color: "white"
        level: 1
        text: qsTr("ArttulOS is now Installed! Enjoy!")
        ...
        Text {
            ...
            Please restart into your new system for the best experience.").arg(Branding.string(Branding.ProductName))
        }
    ...
    RowLayout {
        ...
        Button {
            id: button
            text: qsTr("Close ArttulOS Installer")
